...
<h2>${insuranceInfoDTO.carInfoDTO.carTitle}</h2>
<div class="InsuranceQuoterInfo">
    <label>承险公司：</label><span>${insuranceInfoDTO.quoter.company.name}</span>
</div>
<div class="InsuranceQuoterInfo">
    <label>报价人手机号：</label><span>${insuranceInfoDTO.quoter.name} ${insuranceInfoDTO.quoter.phone}</span>
</div>

<h3 class="CompulsoryInsuranceTitle">交强险 车船使用税(元)</h3>
<div class="InsuranceQuoteFormGroup ClearFix">
<c:forEach items="${insuranceInfoDTO.detailList}" var="detail">
